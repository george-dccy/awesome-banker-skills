...
复制 [prompts/entrypoints/doubao/](prompts/entrypoints/doubao/) 下的入口提示词，再附上仓库地址和你的问题即可。

- 想系统提升金融能力 → [点这里](prompts/entrypoints/doubao/financial-capability.md)
- 公开咨询用户 → [点这里](prompts/entrypoints/doubao/public-consulting.md)
